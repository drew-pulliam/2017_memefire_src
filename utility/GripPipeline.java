...
public class GripPipeline {
	...
	public void process(Mat source0) {
		...
		double[] hsvThresholdValue = {70.0, 200.0};  //16, 102
	...
	public void processGear(Mat source0) {
		...
		double[] hsvThresholdHue = {70.0, 100.0};  //76, 95.0
		double[] hsvThresholdSaturation = {200.0, 255.0}; //213
		double[] hsvThresholdValue = {40.0, 255.0};  //16, 102
		hsvThreshold(hsvThresholdInput, hsvThresholdHue, hsvThresholdSaturation, hsvThresholdValue, hsvThresholdOutput);
	...
	private void filterContours(List<MatOfPoint> inputContours, double minArea,
		...
		for (int i = 0; i < inputContours.size(); i++) {
			...
			Imgproc.rectangle(sourceImage, new Point(bb.x, bb.y), new Point(bb.x+bb.width, bb.y+bb.height), new Scalar(0,0,255,0), 2, Imgproc.LINE_8, 0);
